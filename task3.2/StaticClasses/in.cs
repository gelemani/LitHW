...
public sealed class UnoDimensional : MainClass 
{
    private int length;
    private int[] array;
    private bool choice;
...
public sealed class DosDimensional : Mainlass
{
...
public sealed class JaggedDimensional : MainClass
{
    private int rows;
    private int[][] array;
